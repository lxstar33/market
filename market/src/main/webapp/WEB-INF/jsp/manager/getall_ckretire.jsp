					...
					<div class="row">
						<form class="form-inline" action="getbyparams" method="post">
								 ...
								 <div class="form-group">
								  ...
								  <a href="${pageContext.request.contextPath }/Admin/flatform/ckretire/toadd" class="btn btn-primary " role="button">新增</a>
								  </span>
		                    </form>
		                </div>
					<div class="row">
	                  <div class="x_content">
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath }/Admin/flatform/ckretire/getall?pn=1">首页</a></li>
									<c:if test="${pageInfo.hasPreviousPage }">
										<li><a href="${pageContext.request.contextPath }/Admin/flatform/ckretire/getall?pn=${pageInfo.pageNum-1}"
									...
									<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
										...
										<c:if test="${page_Num != pageInfo.pageNum }">
											<li><a href="${pageContext.request.contextPath }/Admin/flatform/ckretire/getall?pn=${page_Num }">${page_Num }</a></li>
										</c:if>
									...
									<li><a href="${pageContext.request.contextPath }/Admin/flatform/ckretire/getall?pn=${pageInfo.pages}">末页</a></li>
								</ul>
								</nav>
							</div>
						</div>
